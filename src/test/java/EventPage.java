...
public class EventPage extends PageBase{
    ...
    private final By selectedEvent = By.xpath("//a[@href='/hu/event/623db6ddc68c8449031432ce']");
    ...
    private final By attendName = By.xpath("//input[@name='NjIzZGI3N2RjNjhjODQwMzcwMTQzMzBkOjA=.name']");
    private final By attendemail = By.xpath("//input[@name='NjIzZGI3N2RjNjhjODQwMzcwMTQzMzBkOjA=.623db7a5c68c8423d3143320']");
